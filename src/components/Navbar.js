...
const Navbar = (props) => {
    ...
    return (
        <div className="bg-black   w-screen min-w-[360px] shadow-md ">
            <div className=" flex w-10/12 min-w-[360px] py-5 mx-auto justify-between px-7 flex-wrap items-center gap-4 ">
